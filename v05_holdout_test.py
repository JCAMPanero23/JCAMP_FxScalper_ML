"""
HOLDOUT TEST — v05 LONG Model Final Evaluation
==============================================
...
- v05 Risk/Reward: win=+3.0R, loss=-1.0R, timeout=0.0R
"""
...
print("="*70)
print("HOLDOUT TEST — v05 LONG MODEL FINAL EVALUATION")
print("="*70)
print(f"Started: {datetime.now().isoformat()}\n")

DATA_PATH = Path("data/DataCollector_EURUSD_M5_20230101_220446.csv")
MODEL_OUTPUT_DIR = Path("models")
OUTPUT_DIR = Path("outputs/holdout_test_v05")
...
model_path = MODEL_OUTPUT_DIR / "eurusd_long_v05_holdout.joblib"
...
print("="*70)
print(f"HOLDOUT TEST — v05 LONG MODEL @ THRESHOLD {THRESHOLD}")
print("="*70)
...
if n_trades == 0:
    ...
    # Assign R per trade (v05: win=+3.0R, loss=-1.0R, timeout=0.0R)
    ...
    # Profit factor (v05: gross_wins = n_wins * 3.0, gross_losses = n_losses * 1.0)
    ...
    if expectancy > 0 and within_30:
        ...
        print(f"   Proceed to Phase 3 (FastAPI) and Phase 4 (trading cBot deployment).")
        verdict = "PASS"
